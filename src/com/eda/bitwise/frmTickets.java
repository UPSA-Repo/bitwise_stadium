...
public class frmTickets extends javax.swing.JFrame {
    ...
    public void mostrar() {
        String[] nombreColumnas = new String[]{"Id Ticket", "Id Seccion", "Id Partido", "Nro Asiento"};
        ...
        while (i < estadio.getPartidos().get(indexPartidoActual).getTickets().size()) {
            ...
            data[i][1] = ticket.getIdSeccion();
            data[i][2] = ticket.getIdPartido();
    ...
    private void btnComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprarActionPerformed
        ...
        Ticket ticket = new Ticket(idSeccion, idPartido, nroAsiento);
        ticket.registrar();
        estadio.cargarPartidos();
